        ...
        <div className='row justify-content-between'>
          ...
          <div className='col-lg-10'>
            ...
            <div className='row p-4 justify-content-center'>
              ...
              <div className='col-lg-3'><Link href={'ProductPage/productdetails'}><ProductDetails image="/2120470-002.01_450x.jpg" overlayimg="/2120470-002.02_450x.jpg" text="The Open Back Poplin Maxi Dress in Sepia" spantext="New" price="$149.00" colour="1 Colour" /></Link>  </div>
